...
export default function BacklinksPage() {
  ...
  return (
    <div className="space-y-10 w-full max-w-6xl mx-auto pb-16">
      ...
      {/* Opportunities Grid or Clean Empty State */}
      {filteredItems.length > 0 ? (
        ...
        <div className="p-12 text-center bg-gray-900/60 border border-gray-800 rounded-3xl space-y-4 max-w-2xl mx-auto shadow-xl">
          ...
          <h3 className="text-xl font-bold text-white">No Backlink Opportunities Discovered Yet</h3>
          <p className="text-sm text-gray-400 max-w-md mx-auto">
            Type your niche or website domain above to trigger our live AI agent web search across real guest post opportunities.
          </p>
          
          <div className="pt-2 flex flex-wrap items-center justify-center gap-2">
            <span className="text-xs text-gray-500 font-semibold">Try searching:</span>
            {["SaaS", "DevTools", "Marketing", "AI Technology", "Fintech"].map((pill) => (
              <button
                key={pill}
                type="button"
                onClick={() => {
                ...
                className="px-3 py-1 bg-gray-800 hover:bg-blue-950/80 border border-gray-700 hover:border-blue-700/60 text-gray-300 hover:text-blue-300 text-xs font-semibold rounded-full transition"
              >
                {pill}
              </button>
            ))}
